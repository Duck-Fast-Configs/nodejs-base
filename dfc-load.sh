...
"1")
    ...
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-nodejs/Load && sh dfc-stop.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-nodejs/Load && sh dfc-high.sh -d1) >&3
    ;;
"2")
    message_space 1
    
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-nodejs/Load && sh dfc-stop.sh -d1) >&3
    (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-nodejs/Load && sh dfc-low.sh -d1) >&3
    ;;
"3")
    message_space 1
